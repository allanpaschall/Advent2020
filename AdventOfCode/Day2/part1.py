...
for i in s:
	...
	x = test[2]
	password = test[4]
	if password.count(x) >= int(mini) and password.count(x) <= int(maxi):
		correct.append(password)
print(str(len(correct)))
...
for i in s:
	...
	x = test[2]
	password = test[4]
	if password[int(mini)-1] == x and password[int(maxi)-1] != x:
		correct.append(password)
	if password[int(mini)-1] != x and password[int(maxi)-1] == x:
		correct.append(password)
print(str(len(correct)))